...
**Paper:** arXiv [2608.16096](https://arxiv.org/abs/2608.16096) · local copy [`paper/commercial_tax_v11.pdf`](paper/commercial_tax_v11.pdf) (23 pp., 2026-08-17).
...
Embedding matrices (`.npy`, 2.4 GB: all thirteen entrants, both corpus formats where measured, and the replicate's independent anchor embedding) are not in git. Companion dataset: [`toryx-ai/commercial-tax-musique-embeddings`](https://huggingface.co/datasets/toryx-ai/commercial-tax-musique-embeddings) on HuggingFace, pinned at revision `bd00a9c32c00fe9007f9244475f1b11ba7d51f69` (the revision the paper cites; `SHA256SUMS` in the dataset covers every matrix). Archived snapshot of this repository (tag `v1.0-paper1`): Zenodo DOI [10.5281/zenodo.21972866](https://doi.org/10.5281/zenodo.21972866).
